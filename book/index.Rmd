...
1. *Ser una propuesta didáctica de manejo de portafolios*. Esto es, presentar de forma simple y con ejemplos las bases, en términos de lenguaje y manejo de datos, los conceptos que son parte del día a día de los manejadores de portafolios. 
...
Adicionalmente el público ideal tiene conocimiento básico de **R** y está interesado en aprender como usar **R** para manipular portafolios pues presentaremos todas las partes de una paquetería que permitirá al lector replicar todos los cálculos. Esta paquetería se encuentra en __REF__ y lo único que se require para descargarla es usar el siguiente código desde **R**.
...
Finalmente el tercer objetivo de este trabajo se desarrolla en el capítulo \@ref(rendimientos-implicitos) donde desarrolamos las ideas para construir un índice de paridad de fuentes riesgo. Posteriormente utilizamos los retornos implícitos de este índice en la optimización de media-varianza para obtener curvas de portafolios óptimos y elegimos una estrategia óptima de inversión. Los ejemplos que presentaremos en ese capítulo utilizan ETF's multi-activos.
