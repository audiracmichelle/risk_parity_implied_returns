...
```{r portfolio_weights, fig.cap='Pesos de cierre de los componentes de un portafolio', out.width="70%", fig.align="center", fig.pos="H"}
plot_xts(portfolio_weights)
```

Veamos en la figura \@ref(fig:portfolio_weights) las diferencias entre los pesos iniciales de las componentes del portafolio y sus pesos al 30 de junio de 2017:
...
```{r contrib-rebalanceo, fig.cap='Contribuciones al rendimiento despues del rebalanceo', out.width="70%", fig.align="center", fig.pos="H"}
...
```{r pesos-cap, fig.cap='Pesos de capitalizacion de mercado de un indice hipotetico de dos accioens', out.width="70%", fig.align="center", fig.pos="H"}
plot_xts(rebalance$portWeight)
```
