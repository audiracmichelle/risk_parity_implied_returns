...
En este trabajo, además de construir índices de paridad de riesgo, extendemos la manera en que se usan estos métodos. Presentamos una estrategia de inversión en donde se introducen los retornos de estos índices en la optimización de media-varianza invertida para obtener rendimientos implícitos.
...
Al evaluar nuestra estrategia, ¡mostramos que se supera exitosamente al portafolio de referencia! Finalemente, para despedirnos, vamos a proponerle al lector una idea de cómo complementar la estrategia que presentamos con estadísitica bayesiana.
...
Utilizando el Teorema de Bayes, se combinan los retornos implícitos y las expectativas relativas o absolutas del manejador. Esto resulta muy valioso para los manejadores pues los retornos esperados no sólo contienen información del pasadoque se extrae del portafolio de equilibrio. 

El inconveniente de Black-Litterman es que para determinar el valor de las expectativas y su certidumbre requiere experiencia y mantenerse constatemente informado. En cambio los métodos en los que nos enfocamos en este trabajo solo requiren precios y pueden ser usado por alguien sin experienca.

En la introducción mencionamos que este trabajo está especialmente dirigido a estudiantes que quieren empezar a construir portafolios. Además, le sugerimos al lector que descargara la paquetería __REF__ de github y replicara el código que presentamos. Invitamos a los que se animaron a probar las funciones que compartimos a jugar con diferentes instrumentos. La meta final es que aquellos que no contaban con conocimiento previo de manejo de portafolios y que nos acompañaron en este recorrido cuenten con el lenguaje para acercarse a cualquier artículo de portafolios y que se aventuren a invertir en alguna plataforma en línea.
