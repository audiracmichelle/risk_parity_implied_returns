...
En la introducción mencionamos que este trabajo está especialmente dirigido a estudiantes que quieren empezar a construir portafolios. Además, se le sugirió al lector que descarga la paquetería __REF__ de github y replicara el código que presentamos. Invitamos a los que se animaron a probar las funciones que compartimos a jugar con diferentes instrumentos. La meta final es que aquellos que no contaban con conocimiento previo de manejo de portafolios y que nos acompañaron en este recorrido cuenten con el lenguaje para acercarse a cualquier artículo de portafolios y que se aventuren a invertir en alguna plataforma en línea.
